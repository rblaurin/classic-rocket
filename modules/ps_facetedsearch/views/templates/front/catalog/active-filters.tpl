    ...
    <div class="active_filters__list">
      {foreach from=$activeFilters item="filter"}
        {block name='active_filters_item'}
            <a class="js-search-link active_filters__list-item btn btn-sm btn-light text-body" href="{$filter.nextEncodedFacetsURL}"><i class="material-icons text-primary">&#xE5CD;</i> {l s='%1$s: ' d='Shop.Theme.Catalog' sprintf=[$filter.facetLabel]}
